...
def main() -> None:
    ...
    openai_llm_service: OpenAILLMService = get_llm_service()
    answer = openai_llm_service.generate_answer(prompt_result)
    ...
    for source in answer.sources:
        print(
            f"  - report={source.report_id}, section={source.metadata.get('section')}"
        )
